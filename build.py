...
.mnav{
  ...
  /* ink sheet + a 1px hairline exactly where the bar ends (the bar height is
     scroll-driven via --navp, inherited from .nav); a background layer on the
     scroll container stays put while the menu content scrolls */
  background:
    linear-gradient(var(--edge),var(--edge)) 0 calc(110px - 22px * var(--navp)) / 100% 1px no-repeat,
    var(--ink);
