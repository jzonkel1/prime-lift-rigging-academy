...
.mnav{
  ...
  background:var(--ink);
  padding-top:calc(110px + 6px); -webkit-overflow-scrolling:touch;
}
.nav.stuck .mnav{padding-top:calc(88px + 6px)}
...
body.mnav-open .nav{background:var(--ink); border-bottom-color:var(--edge); backdrop-filter:none; transition:none; z-index:80}
